...
module.exports = {
  ...
  **************************************************************************/
  datastores: {
    ...
    ***************************************************************************/
    default: {
      adapter: process.env.bdAdapter,
      url: process.env.bdType + '://' + process.env.bdUser + ':' + process.env.bdPassword + '@' + process.env.bdHost + ':' + process.env.bdPort + '/' + process.env.bdDatabase,
  ...
  ***************************************************************************/
  blueprints: {
    shortcuts: process.env.shortcuts || '',
